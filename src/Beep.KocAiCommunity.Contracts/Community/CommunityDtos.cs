...
public sealed record ReplyDto(Guid Id, string AuthorUserId, string Body, DateTime CreatedUtc, IReadOnlyList<ReactionDto> Reactions);

public sealed record DiscussionDto(
    Guid Id, string Title, string Body, string Scope, string AuthorUserId, DateTime CreatedUtc,
